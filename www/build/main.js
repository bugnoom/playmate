...
var map = {
	"../pages/getjobsprofile/getjobsprofile.module": [
		308,
		4
	],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_getjobs_getjobs__ = __webpack_require__(307);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_header_header__ = __webpack_require__(302);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__components_footer_footer__ = __webpack_require__(303);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_4__angular_core__["L" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_19__components_footer_footer__["a" /* FooterComponent */],
                __WEBPACK_IMPORTED_MODULE_17__pages_getjobs_getjobs__["a" /* GetjobsPage */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_5_ionic_angular__["d" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_11__app_component__["a" /* MyApp */], {
                    ...
                    links: [
                        ...
                        { loadChildren: '../pages/getjobsprofile/getjobsprofile.module#GetjobsprofilePageModule', name: 'GetjobsprofilePage', segment: 'getjobsprofile', priority: 'low', defaultHistory: [] }
                    ]
                })
            ],
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GetjobsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(19);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var GetjobsPage = /** @class */ (function () {
    function GetjobsPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    GetjobsPage.prototype.ionViewDidLoad = function () {
        this.footnavmenu = '';
    };
    GetjobsPage.prototype.ionViewCanEnter = function () {
        this.footnavmenu = '';
    };
    GetjobsPage.prototype.goto = function (t) {
        if (t == 'getjob') {
    ...
    GetjobsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-getjobs',template:/*ion-inline-start:"/Users/bugnoom/Desktop/Pretty/mobile_apps/playmate/src/pages/getjobs/getjobs.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title></ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content  text-center no-padding>\n  <ion-grid class="getjobs" no-padding>\n    <ion-row>\n      <ion-col>\n        <div (click)="goto(\'profile\')"><img src="assets/getjobs/profile_icon.jpg" ></div>\n        <p>&nbsp;</p>\n         <div (click)="goto(\'getjob\')"><img src="assets/getjobs/getjobs_icon.jpg" ></div>\n      </ion-col>\n    </ion-row>\n    \n  </ion-grid>\n</ion-content> \n\n<ion-footer no-border no-padding>\n  <footer [footnavmenu]="footnavmenu"></footer>\n</ion-footer>'/*ion-inline-end:"/Users/bugnoom/Desktop/Pretty/mobile_apps/playmate/src/pages/getjobs/getjobs.html"*/,
        }),
